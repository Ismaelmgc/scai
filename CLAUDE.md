...
- TOP_K=8 equal-weight (**acciones fraccionadas** → cada nombre exacto al 12.5%, sin cash ocioso por redondeo, calza con el backtest), holding 20d, rebalance 5d, trailing stop ATR clipped [10%, 16%], cooldown 5d tras salida, **profit target +40%** (v4.0).
